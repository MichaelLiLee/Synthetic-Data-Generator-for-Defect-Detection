...
class CameraEffectRandomizer:
    """
    A randomizer class which simulates vary camera sensor effects - chromatic aberration, blur, exposure, 
    ...
    camera_effect_randomize(): Randomizes vary camera sensor effects - chromatic aberration, blur, motion blur ,exposure, noise, color temperature, brightness, 
                        contrast, hue and saturation.
    
    References
    ----------
    [1]https://www.adamsmith.haus/python/answers/how-to-sample-a-random-number-from-a-probability-distribution-in-python
    [2]https://blender.stackexchange.com/questions/5387/how-to-handle-creating-a-node-group-in-a-script
    [3]https://blenderartists.org/t/python-add-custom-nodegroup/1205661

    Color Temperature (Kelvin) to RGB
    [4]https://blenderartists.org/t/blackbody-behavior-when-using-with-light-sources/1452214 # Create WhitebalanceNode
    [5]https://blender.stackexchange.com/questions/111325/using-python-how-can-i-preset-points-in-shadernode-rgb-curves
    [6]https://tannerhelland.com/2012/09/18/convert-temperature-rgb-algorithm-code.html

    White balance augmentation papers: 
    [7] Afifi, Mahmoud, and Michael S. Brown. "What else can fool deep learning? Addressing color constancy errors on deep neural network performance." ICCV2019.
    [8] Afifi, Mahmoud, et al. "When color constancy goes wrong: Correcting improperly white-balanced images." CVPR2019.

    Modeling Camera Effects to Improve Visual Learning from Synthetic Data:
    [9]Carlson, Alexandra, et al. "Modeling camera effects to improve visual learning from synthetic data." ECCV2018.
    [10]ChromaticAberration: https://blender.stackexchange.com/questions/168498/is-chromatic-aberration-possible-in-blender
    [11]Blur: https://docs.blender.org/manual/en/latest/compositing/types/filter/blur_node.html
    [12]Motion Blur: https://docs.blender.org/manual/en/latest/compositing/types/filter/vector_blur.html
    [13]Exposure: https://docs.blender.org/manual/en/latest/compositing/types/color/exposure.html
    [14]Noise: https://blender.stackexchange.com/questions/238692/how-to-add-film-grain-using-the-compositor
    [15]Brightness & Contrast: https://docs.blender.org/manual/en/latest/compositing/types/color/bright_contrast.html
    [16]Hue & Saturation: https://docs.blender.org/manual/en/latest/compositing/types/color/hue_saturation.html

    """
    def __init__(self,
                 camera_focal_length = 35,
                 img_resolution_x = 3000,
                 img_resolution_y = 3000,
                 max_samples = 512,
                 ...
                 exposure_value_range = {"min": -0.5, "max": 0.5},
                 ...
                 hue_probability = 1.0,
                 hue_value_range = {"min": 0.48, "max": 0.52},
                 saturation_probability = 1.0,
                 saturation_value_range = {"min": 0.8, "max": 1.2}
                 ):
    ...
    def __set_curve_point_loction(self, curve_channel, point_list):
        """Set points in RGB Curves node[4,6]."""
    ...
    def __create_wb_node_group(self):
        """Create the WhiteBalanceNode node group[4,5]."""
    ...
    def __chromatic_aberration_randomize(self):
        """Randomizes the value of Lens Distortion nodes input-Dispersion, which simulates chromatic aberration[10]."""
    ...
    def __blur_randomize(self):
        """Randomizes the value of Blur nodes input-Size, which controls the blur radius values[11].""" 
    ...
    def __exposure_randomize(self):
        """Randomizes the value of Exposure nodes input-Exposure, which controls the scalar factor to adjust the exposure[13].""" 
    ...
    def __noise_randomize(self):
        """Randomizes the value of brightness of the noise texture[14]."""
        # Set happen distribution
    ...
    def __brightness_randomize(self):
        """Randomizes the value of Bright/Contrast nodes input-Bright, which adjust the brightness[15]."""
    ...
    def __contrast_randomize(self):
        """Randomizes the value of Bright/Contrast nodes input-Contrast, which adjust the contrast[15].""" 
    ...
    def __hue_randomize(self):
        """Randomizes the value of Hue Saturation Value nodes input-Hue, which adjust the hue[16]."""
    ...
    def __saturation_randomize(self):
        """Randomizes the value of Hue Saturation Value nodes input-Saturation, which adjust the saturation[16]."""
    ...
    def camera_effect_randomize(self):
        """Randomizes vary camera sensor effects - chromatic aberration, blur, exposure, noise, color temperature, 
