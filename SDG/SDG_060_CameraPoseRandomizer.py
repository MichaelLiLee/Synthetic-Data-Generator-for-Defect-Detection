...
class CameraPoseRandomizer:
    def __init__(self,
                fibonacci_sphere_radius_range = {"min":0.1, "max":0.2},
                fibonacci_sphere_sample_area = 0.0001,
                camera_normal_angle_range = {"min":60, "max": 90},
                camera_offset_location_range = {"min": - 0.003 , "max": 0.003},
                camera_offset_rotation_range = {"min":-5, "max":5}
                ):

        self.__object_camera_need_to_point = bpy.data.objects["Plane"]
    ...
    def __random_camera_offset(self):
        ...
        camera_offset_rotation_z = random.uniform(self.camera_offset_rotation_range["min"]/360, self.camera_offset_rotation_range["max"]/360) * 2 * math.pi
        cam.rotation_euler.x = cam.rotation_euler.x + camera_offset_rotation_x
        cam.rotation_euler.y = cam.rotation_euler.y + camera_offset_rotation_y
        cam.rotation_euler.z = cam.rotation_euler.z + camera_offset_rotation_z
